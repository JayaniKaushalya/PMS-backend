<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DueAmountReport.aspx.cs" Inherits="TestProject00.DueAmountReport" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Due Amount Report</title>
    <style type="text/css">
        .auto-style4 {
            height: 10px;
        }
    ...
    <form id="frmMonthlyReport" runat="server">
        <div style="height: auto">
            ...
            <table style="height: 335px; width: 900px; margin-right: 0px; margin-bottom: 0px;">
                <tr>
                    <th class="auto-style5"> <h3 style="color: #3D1963; height: 40px;"> Due Amount Report </h3></th>
                </tr>
                <tr>
