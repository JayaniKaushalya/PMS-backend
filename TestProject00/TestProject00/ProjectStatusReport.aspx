<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectStatusReport.aspx.cs" Inherits="TestProject00.ProjectStatusReport" %>
    ...
    <form id="frmMonthlyReport" runat="server">
        <div style="height: auto">
            ...
            <table style="height: 335px; width: 900px; margin-right: 0px; margin-bottom: 0px;">
                <tr>
                    <th class="auto-style5"> <h3 style="color: #3D1963; height: 40px;"> Project Status Report </h3></th>
                </tr>
                <tr>
