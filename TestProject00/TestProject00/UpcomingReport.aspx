<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpcomingReport.aspx.cs" Inherits="TestProject00.UpcomingReport" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
     <title>Upcoming Report</title>
    ...
    <form id="frmMonthlyReport" runat="server">
        <div style="height: auto">
            ...
            <table style="height: 335px; width: 900px; margin-right: 0px; margin-bottom: 0px;">
                <tr>
                    <th class="auto-style5"> <h3 style="color: #3D1963; height: 40px;"> Upcoming Report </h3></th>
                </tr>
                <tr>
                ...
                <div style="height: auto">
                    <asp:Table ID="TMReport" runat="server" CellPadding="10" GridLines="Both" HorizontalAlign="center" width="80%">
                        <asp:TableRow>
                            ...
                            <asp:TableCell ForeColor="#882464" Font-Bold="true"> Telephone Number </asp:TableCell>
                            <asp:TableCell ForeColor="#882464" Font-Bold="true"> Total payment </asp:TableCell>
                            <asp:TableCell ForeColor="#882464" Font-Bold="true"> Paid Amount </asp:TableCell>
                            <asp:TableCell ForeColor="#882464" Font-Bold="true"> Balance </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
